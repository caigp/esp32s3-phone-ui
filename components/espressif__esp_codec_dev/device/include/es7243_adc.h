...
/**
 * @brief  ES7243 codec configuration, only supports ADC feature
 */
typedef struct {
 ...
 *
 * @note  Call this API after I2S clock is ready; otherwise register writes may fail.
 *
 * @param[in]  codec_cfg  ES7243 codec configuration
 *
 * @return
 *       - NULL    Fail to new ES7243 codec interface
