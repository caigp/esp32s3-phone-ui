...
int zl38063_comm(int argc, char **argv)
{
    ...
    if ((strcmp(argv[1], "-wr") == 0) || (strcmp(argv[1], "-rd") == 0)) {
        ...
        if (1) {
            ...
            if (mute) {
                printf("ROUT Port muted successfully...\n");
            } else {
                printf("ROUT Port unmuted successfully...\n");
            }
        }
        ...
        if (1) {
            ...
            if (mute) {
                printf("SOUT Port muted successfully...\n");
            } else {
                printf("SOUT Port unmuted successfully...\n");
            }
        }
